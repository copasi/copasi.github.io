...
<!-- generated with COPASI 4.46 (Build 300) (http://www.copasi.org) at 2026-04-28T14:39:04Z -->
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_0" name="k1" value="1"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_1">
        ...
        <ListOfConstants>
          <Constant key="Parameter_1" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=The Brusselator,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="Histogram" type="Plot2D" active="1" taskTypes="">
      ...
      <Parameter name="plot engine" type="string" value="QCustomPlot"/>
      <ListOfPlotItems>
        <PlotItem name="Histogram: [X]" type="Histogram1DItem">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
