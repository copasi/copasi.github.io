...
<!-- generated with COPASI 4.46 (Build 300) (http://www.copasi.org) at 2026-04-28T14:19:06Z -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="46" versionDevel="300" copasiSourcesModified="0">
  <Model key="Model_1" name="Himmelblau" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_1">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_2" name="f" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          (&lt;CN=Root,Model=Himmelblau,Vector=Values[x],Reference=InitialValue>^2+&lt;CN=Root,Model=Himmelblau,Vector=Values[y],Reference=InitialValue>-11)^2+(&lt;CN=Root,Model=Himmelblau,Vector=Values[x],Reference=InitialValue>+&lt;CN=Root,Model=Himmelblau,Vector=Values[y],Reference=InitialValue>^2-7)^2
        </Expression>
      </ModelValue>
    </ListOfModelValues>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Himmelblau" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Himmelblau,Vector=Values[x]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Himmelblau,Vector=Values[y]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Himmelblau,Vector=Values[f]" value="170" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Himmelblau,Vector=Values[x],Reference=InitialValue"/>
          ...
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Minimum" type="float" value="-6"/>
            <Parameter name="Number of steps" type="unsignedInteger" value="40"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Himmelblau,Vector=Values[y],Reference=InitialValue"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="log" type="bool" value="0"/>
            <Parameter name="Use Values" type="bool" value="0"/>
            <Parameter name="Values" type="string" value=""/>
    ...
    <Task key="Task_21" name="Optimization" type="optimization" scheduled="true" updateModel="false">
      <Report reference="Report_13" target="" append="1" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Subtask" type="cn" value="CN=Root,Vector=TaskList[Time-Course]"/>
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=Himmelblau,Vector=Values[f],Reference=InitialValue>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Himmelblau,Vector=Values[x],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="-1.8659699999999999"/>
            <Parameter name="UpperBound" type="cn" value="6"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-6"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Himmelblau,Vector=Values[y],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="-0.93046099999999998"/>
            <Parameter name="UpperBound" type="cn" value="6"/>
          </ParameterGroup>
        </ParameterGroup>
  ...
  <ListOfPlots>
    <PlotSpecification name="Contours" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[y].InitialValue/Values[f].InitialValue|Values[x].InitialValue" type="Spectogram">
          ...
          <Parameter name="contours" type="string" value="250 750 100 50 25 5"/>
          <Parameter name="maxZ" type="string" value=""/>
          <Parameter name="colorMap" type="string" value="Default"/>
          <Parameter name="Color" type="string" value="auto"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Himmelblau,Vector=Values[x],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Himmelblau,Vector=Values[y],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Himmelblau,Vector=Values[f],Reference=InitialValue"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
