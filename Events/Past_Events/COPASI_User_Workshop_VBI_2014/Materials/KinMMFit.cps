...
<!-- generated with COPASI 4.5 (Build 30) (http://www.copasi.org) at 2009-07-09 20:38:37 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="30">
  ...
  <Model key="Model_1" name="Kinetics of a  Michaelian enzyme measured spectrophotometrically" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
...
<p>You should experiment solving the problem with several optimisation methods, such as Nelder-Mead, Levenberg-Marquardt, Genetic algorithm, or Particle swarm (others are good too).</p>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="R1" reversible="true">
        ...
        <ListOfConstants>
          <Constant key="Parameter_92" name="k1" value="125.659"/>
          <Constant key="Parameter_91" name="k2" value="14.0251"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="R2" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_541" name="k1" value="46.0991"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+18 6.022141500000001e+21 0 0 0.02754596181702538 8.959580272963096 0.78 0.02754596181702538 1
    </InitialState>
  </Model>
  <ListOfTasks>
